...
class TriggerConfigTest {
  ...
  class PlayerListConfigTests {
    ...
    void shouldParsePlayerList() {
      TriggerConfig config =
          withRaw(
              "connection",
              Map.of(
                  "player_list", Map.of("mode", "blacklist", "players", List.of("Steve", "Alex"))));
    ...
    void modeShouldDefaultToWhitelist() {
      TriggerConfig config =
          withRaw("connection", Map.of("player_list", Map.of("players", List.of("Steve"))));
    ...
    void shouldParseServerList() {
      TriggerConfig config =
          withRaw(
              ...
              Map.of(
                  "server_list",
                  Map.of("mode", "whitelist", "servers", List.of("lobby", "survival"))));
    ...
    void shouldParseVirtualHostList() {
      TriggerConfig config =
          withRaw(
              ...
              Map.of(
                  "virtual_host_list",
                  Map.of("mode", "whitelist", "virtual_hosts", List.of("play.example.com"))));
