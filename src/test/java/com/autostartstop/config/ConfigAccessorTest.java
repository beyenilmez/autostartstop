...
class ConfigAccessorTest {
  ...
  class BooleanTests {
    ...
    void shouldParseAlternativeBooleans() {
      ConfigAccessor acc =
          new ConfigAccessor(Map.of("y", "yes", "one", "1", "n", "no", "zero", "0"), "test");
  ...
  class ListTests {
    ...
    void shouldConvertMapList() {
      List<Map<String, Object>> maps = List.of(Map.of("type", "start"), Map.of("type", "stop"));
  ...
  class EnumTests {
    ...
    void shouldParseLeniently() {
      ConfigAccessor acc =
          new ConfigAccessor(Map.of("lower", "red", "upper", "RED", "hyphen", "dark-blue"), "t");
