...
class VariableResolverTest {
    ...
    class ResolveDurationTests {
        ...
        void shouldResolveVariable() {
            ...
            assertEquals(Duration.ofSeconds(10), resolver.resolveDuration("${delay}", context, Duration.ZERO));
        }

        @Test
        @DisplayName("should return default for invalid or blank input")
        void shouldReturnDefault() {
            assertEquals(Duration.ofMinutes(1), resolver.resolveDuration("invalid", context, Duration.ofMinutes(1)));
            assertEquals(Duration.ofMinutes(1), resolver.resolveDuration("", context, Duration.ofMinutes(1)));
        }
    }
    ...
    class ResolveEnumTests {
        ...
        void shouldResolveUppercase() {
            assertEquals(ServerState.ONLINE,
        ...
        void shouldReturnDefault() {
            assertEquals(ServerState.UNKNOWN,
