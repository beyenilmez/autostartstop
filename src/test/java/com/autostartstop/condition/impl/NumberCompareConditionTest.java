...
class NumberCompareConditionTest {
  ...
  class EqualsTests {
    ...
    void shouldReturnTrueWhenEqual() {
      NumberCompareCondition condition =
          new NumberCompareCondition("42", null, null, "42", resolver);
    ...
    void shouldReturnFalseWhenNotEqual() {
      NumberCompareCondition condition =
          new NumberCompareCondition("42", null, null, "43", resolver);
    ...
    void shouldHandleDecimalEquals() {
      NumberCompareCondition condition =
          new NumberCompareCondition("3.14", null, null, "3.14", resolver);
      assertTrue(condition.evaluate(context));
    }
  }
  ...
  class MinTests {
    ...
    void shouldReturnTrueAboveMin() {
      NumberCompareCondition condition =
          new NumberCompareCondition("10", "5", null, null, resolver);
      assertTrue(condition.evaluate(context));
    }
  ...
  class MaxTests {
    ...
    void shouldReturnTrueBelowMax() {
      NumberCompareCondition condition =
          new NumberCompareCondition("5", null, "10", null, resolver);
      assertTrue(condition.evaluate(context));
    }
    ...
    void shouldReturnTrueAtMax() {
      NumberCompareCondition condition =
          new NumberCompareCondition("10", null, "10", null, resolver);
      assertTrue(condition.evaluate(context));
    }
    ...
    void shouldReturnFalseAboveMax() {
      NumberCompareCondition condition =
          new NumberCompareCondition("15", null, "10", null, resolver);
      assertFalse(condition.evaluate(context));
    }
  }
  ...
  class RangeTests {
    ...
    void shouldReturnTrueAtMaxBoundary() {
      NumberCompareCondition condition =
          new NumberCompareCondition("10", "5", "10", null, resolver);
      assertTrue(condition.evaluate(context));
    }
    ...
    void shouldReturnFalseAboveRange() {
      NumberCompareCondition condition =
          new NumberCompareCondition("15", "5", "10", null, resolver);
      assertFalse(condition.evaluate(context));
    }
  }
  ...
  class VariableResolutionTests {
    ...
    void shouldResolveValue() {
      ...
      NumberCompareCondition condition =
          new NumberCompareCondition("${count}", "5", "15", null, resolver);
      assertTrue(condition.evaluate(context));
    }
    ...
    void shouldResolveMin() {
      ...
      NumberCompareCondition condition =
          new NumberCompareCondition("10", "${min_val}", null, null, resolver);
      assertTrue(condition.evaluate(context));
    }
    ...
    void shouldResolveMax() {
      ...
      NumberCompareCondition condition =
          new NumberCompareCondition("10", null, "${max_val}", null, resolver);
      assertTrue(condition.evaluate(context));
    }
    ...
    void shouldResolveEquals() {
      ...
      NumberCompareCondition condition =
          new NumberCompareCondition("42", null, null, "${expected}", resolver);
      assertTrue(condition.evaluate(context));
    }
  }
  ...
  class EqualsPriorityTests {
    ...
    void equalsShouldTakePriority() {
      ...
      NumberCompareCondition condition =
          new NumberCompareCondition("42", "100", "50", "42", resolver);
      assertTrue(condition.evaluate(context));
    }
  }
  ...
  class NoConstraintsTests {
    ...
    void shouldReturnTrueNoConstraints() {
      NumberCompareCondition condition =
          new NumberCompareCondition("42", null, null, null, resolver);
      assertTrue(condition.evaluate(context));
    }
    ...
    void shouldReturnTrueBlankConstraints() {
      NumberCompareCondition condition =
          new NumberCompareCondition("42", "  ", "  ", "  ", resolver);
      assertTrue(condition.evaluate(context));
    }
  }
  ...
  class InvalidValueTests {
    ...
    void shouldReturnFalseForNonNumeric() {
      NumberCompareCondition condition =
          new NumberCompareCondition("abc", "0", "100", null, resolver);
      assertFalse(condition.evaluate(context));
    }
    ...
    void shouldHandleUnresolvableValue() {
      NumberCompareCondition condition =
          new NumberCompareCondition("${unknown}", null, null, "42", resolver);
      assertFalse(condition.evaluate(context));
    }
  }
  ...
  class PropertyTests {
    ...
    void shouldReturnType() {
      NumberCompareCondition condition =
          new NumberCompareCondition("1", null, null, null, resolver);
    ...
    void shouldReturnProperties() {
      NumberCompareCondition condition =
          new NumberCompareCondition("10", "5", "20", "15", resolver);
