...
class StringEqualsConditionTest {
  ...
  class BasicComparisonTests {
    ...
    void shouldReturnTrueForEqual() {
      StringEqualsCondition condition =
          new StringEqualsCondition("hello", "hello", false, resolver);
    ...
    void shouldReturnFalseForDifferent() {
      StringEqualsCondition condition =
          new StringEqualsCondition("hello", "world", false, resolver);
  ...
  class VariableResolutionTests {
    ...
    void shouldResolveValue() {
      ...
      StringEqualsCondition condition =
          new StringEqualsCondition("${status}", "online", false, resolver);
      assertTrue(condition.evaluate(context));
    }
    ...
    void shouldResolveEquals() {
      ...
      StringEqualsCondition condition =
          new StringEqualsCondition("online", "${expected}", false, resolver);
      assertTrue(condition.evaluate(context));
    }
    ...
    void shouldResolveBoth() {
      ...
      context.setVariable("expected", "online");
      StringEqualsCondition condition =
          new StringEqualsCondition("${actual}", "${expected}", false, resolver);
      assertTrue(condition.evaluate(context));
    }
    ...
    void shouldHandleUnresolvable() {
      StringEqualsCondition condition =
          new StringEqualsCondition("${unknown}", "value", false, resolver);
  ...
  class PropertyTests {
    ...
    void shouldReturnValue() {
      StringEqualsCondition condition =
          new StringEqualsCondition("value", "equals", true, resolver);
