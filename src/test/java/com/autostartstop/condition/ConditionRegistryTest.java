...
class ConditionRegistryTest {
  ...
  @Mock private com.autostartstop.server.ServerManager serverManager;
  ...
  class ContextTests {
    ...
    void shouldSetAndGetContext() {
      ...
      ConditionContext ctx = ConditionContext.builder().variableResolver(variableResolver).build();
