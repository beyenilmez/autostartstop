...
class CronTriggerTest {
    ...
    class Factory {
        ...
        void createPreservesOptionalFields() {
            TriggerConfig config = new TriggerConfig();
            config.setType("cron");
            config.setRawConfig(Map.of("expression", "0 * * * *", "time_zone", "Europe/Istanbul", "format", "QUARTZ"));
    ...
    class FormatParsing {
        ...
        void parsesKnownFormats(String input, String expectedName) {
            ...
            String expression = switch (expectedName) {
                case "QUARTZ" -> "0 0 * * * ?";
                case "CRON4J" -> "0 * * * *";
                case "SPRING" -> "0 0 * * * *";
                case "SPRING53" -> "0 0 * * * *";
    ...
    class ContextEmission {
        ...
        /**
         * Activates a CronTrigger and captures the Runnable scheduled by the Velocity scheduler,
         * then invokes it to simulate a cron fire and capture the emitted ExecutionContext.
         */
        ...
        void emitsScheduledTime() {
            ...
            assertTrue(((String) scheduledTime).contains("T"),
                    "scheduled_time should be ISO-8601 format");
        }
        ...
        void emitsActualTime() {
            ...
            assertTrue(((String) actualTime).contains("T"),
                    "actual_time should be ISO-8601 format");
        }
