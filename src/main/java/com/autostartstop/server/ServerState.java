...
/** Normalized server state values. All control APIs should return one of these states. */
public enum ServerState {
   ...
   *
   * @return The state name in lowercase (e.g., "unknown", "offline", "starting", "online",
   *     "failed")
   */
