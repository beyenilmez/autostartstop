...
public final class Log {
  ...
  /**
   * Gets a wrapped logger for the given class. The logger will automatically prefix all messages
   * with [AutoStartStop].
   *
  ...
  /**
   * Gets a wrapped logger with the given name. The logger will automatically prefix all messages
   * with [AutoStartStop].
   *
