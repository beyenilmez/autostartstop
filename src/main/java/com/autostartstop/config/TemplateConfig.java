...
/** Configuration for a template. Delegates to ConfigAccessor for type-safe parsing utilities. */
public class TemplateConfig {
  ...
  /** Gets the empty time duration (for stop_on_empty template). Default: 15 minutes. */
  ...
  /** Gets the connection mode (for start_on_connection template). Default: "none". */
