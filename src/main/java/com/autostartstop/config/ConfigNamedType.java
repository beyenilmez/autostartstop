...
/**
 * Interface for types that have a configuration name. Provides a common pattern for enums that map
...
public interface ConfigNamedType {
  ...
  /**
   * Utility method to find an enum constant by its configuration name. This provides a reusable
   * implementation of the fromConfigName pattern.
   *
