...
/** Configuration for a trigger. Delegates to ConfigAccessor for type-safe parsing utilities. */
public class TriggerConfig {
  ...
  /** Gets the empty time duration (for empty_server triggers). Default: 15 minutes. */
