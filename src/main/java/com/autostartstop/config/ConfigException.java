...
/**
 * Exception thrown when configuration parsing or validation fails. Provides structured information
 * about the component and parameter that caused the error.
 */
public class ConfigException extends RuntimeException {
   ...
   * @return A ConfigException for the invalid value
   */
  public static ConfigException invalid(
      String component, String parameter, Object value, String expected) {
    return new ConfigException(
        component, parameter, "invalid value '" + value + "', expected: " + expected);
  }
