...
/** Configuration for an action. Delegates to ConfigAccessor for type-safe parsing utilities. */
public class ActionConfig {
  ...
  /** Gets the ConfigAccessor for this action's raw config. Lazily initialized on first access. */
