...
public class TriggerRegistry {
  ...
  public Trigger create(TriggerConfig config) {
    ...
    if (type == null) {
      logger.error(
          "Unknown trigger type '{}' - valid types: {}", configType, TriggerType.getValidNames());
      return null;
    }
    ...
    try {
      ...
      if (triggerContext == null) {
        logger.error(
            "TriggerContext is not set - cannot create trigger '{}'", type.getConfigName());
        return null;
      }
