...
public class ProxyShutdownTrigger implements Trigger {
  ...
  public void deactivate() {
    ...
    logger.debug(
        "ProxyShutdownTrigger: deactivating for rule '{}'",
        ruleName != null ? ruleName : "unknown");
  ...
  // Use HIGH priority so this fires BEFORE the main plugin's cleanup handler, should be higher than
  // 50
