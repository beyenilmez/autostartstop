 ...
 * ${manual.args.0}, ${manual.args.1}, ... - Command arguments - ${manual.args.length} - Argument
 * count
 */
public class ManualTrigger implements Trigger {
  ...
  public void deactivate() {
    ...
    logger.debug(
        "ManualTrigger: deactivating for rule '{}'", ruleName != null ? ruleName : "unknown");
  ...
  /**
   * Fires this manual trigger with the given arguments. Called by TriggerCommand when a manual
   * trigger is invoked.
   *
  ...
  public void fire(String[] args) {
    ...
    logger.debug(
        "ManualTrigger: firing trigger '{}' for rule '{}' with {} args", id, ruleName, args.length);
