...
public class ConditionRegistry {
  ...
  public Condition create(Map<String, Object> configMap) {
      ...
      if (type != null) {
        ...
        try {
          ...
          if (conditionContext == null) {
            logger.error(
                "ConditionContext is not set - cannot create condition '{}'", type.getConfigName());
            return null;
          }
    ...
    logger.error(
        "Unknown condition type '{}' - valid types: {}",
        configMap.keySet(),
        ConditionType.getValidNames());
    return null;
  }
