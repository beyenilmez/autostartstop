...
public class StringEqualsCondition implements Condition {
  ...
  public StringEqualsCondition(
      String value, String equals, boolean ignoreCase, VariableResolver variableResolver) {
    this.value = value;
    this.equals = equals;
  ...
  public boolean evaluate(ExecutionContext context) {
    ...
    logger.debug(
        "StringEqualsCondition: comparing '{}' (resolved from '{}') with '{}' (resolved from '{}'), ignoreCase={}",
        resolvedValue,
        value,
        resolvedEquals,
        equals,
    ...
    if (resolvedValue == null || resolvedEquals == null) {
      logger.debug(
          "StringEqualsCondition: one value is null (value={}, equals={}), returning false",
          resolvedValue,
          resolvedEquals);
      return false;
    }
