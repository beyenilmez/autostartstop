...
public class ServerStatusCondition implements Condition {
  private static final Logger logger = PluginLogger.get(ServerStatusCondition.class);
  ...
  public boolean evaluate(ExecutionContext context) {
    ...
    logger.debug(
        "ServerStatusCondition: checking server '{}' (from '{}') for status '{}' (from '{}')",
        resolvedServer,
        server,
        resolvedStatus,
        expectedStatus);
    ...
    logger.debug(
        "ServerStatusCondition: server '{}' is {}, expected {}, result = {}",
        resolvedServer,
        actualStatus,
        resolvedStatus,
        result);
