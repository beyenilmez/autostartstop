...
/**
 * Action that sends a message to one or more players.
 */
public class SendMessageAction extends AbstractPlayerTargetingAction {
    private static final Logger logger = Log.get(SendMessageAction.class);
    
    private final String message;

    public SendMessageAction(String playerParam, List<String> playersParam,
    ...
    /**
     * Creates a SendMessageAction from configuration.
     */
    public static SendMessageAction create(ActionConfig config, ActionContext ctx) {
        ...
        return new SendMessageAction(player, players, server, servers, message, ctx.targetResolver());
    }
