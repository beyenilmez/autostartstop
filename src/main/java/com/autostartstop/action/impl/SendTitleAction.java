...
public class SendTitleAction extends AbstractPlayerTargetingAction {
  private static final Logger logger = PluginLogger.get(SendTitleAction.class);
  ...
  public String getFadeInRaw() {
    return fadeInRaw;
  }

  public String getStayRaw() {
    return stayRaw;
  }

  public String getFadeOutRaw() {
    return fadeOutRaw;
  }
}
