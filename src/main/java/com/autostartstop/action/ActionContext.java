...
/**
 * Context object that provides all dependencies needed by action factories. This allows action
 * classes to have a static create method without needing separate factory classes for each action
 * type.
 */
